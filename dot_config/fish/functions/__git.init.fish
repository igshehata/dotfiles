function __git.init
  ...
  __git.create_abbr gd         ftdv
  __git.create_abbr gdca       ftdv --cached
  ...
  __git.create_abbr glo        git log --oneline --decorate --color --ext-diff
  ...
  __git.create_abbr gsh        git show --ext-diff
